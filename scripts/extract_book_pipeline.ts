...
if (args[0] === 'full-genesis') {
  // Genesis: Page 9 to 60 (approximate end of Genesis in this PDF)
  extractBookBatched('Genesis', 9, 60, 3);
} else {
  // Debug / Usage
  console.log("Usage: tsx scripts/extract_book_pipeline.ts full-genesis");
  if (process.env.DEBUG_RUN) extractBookBatched('Genesis', 9, 14, 5);
}
